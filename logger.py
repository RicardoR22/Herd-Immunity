class Logger(object):
    ...
    def write_metadata(self, pop_size, vacc_percentage, virus_name, mortality_rate,
        ...
        file.write("Virus Name: {} \tPopulation Size: {} \tVaccination Percentage: {} \tMortality Rate: {} \tReproduction Rate: {}".format(virus_name, pop_size, vacc_percentage, mortality_rate, basic_repro_num))
        file.close()
    ...
    def log_interaction(self, person1, person2, did_infect=None,
        ...
        if did_infect == True:
            file.write("{} was infected by {} \n".format(person2, person1))
        else:
            if person2_vacc == True:
                file.write("{} is vaccinated and was not infected by {}.\n".format(person2, person1))
            elif person2_sick == True:
                file.write("{} is already infected, cannot be infected by {}.\n".format(person2, person1))
        file.close()
