...
class Simulation(object):
    ...
    def _create_population(self, initial_infected):
        ...
        while len(population) != pop_size:
            if infected_count !=  initial_infected:
                ...
                # new infected person!
                person = Person(self.next_person_id, False, self.virus_name)
                ...
                vacc_chance = random.uniform(0, 1)
                if vacc_chance < vacc_percentage:
                    person = Person(self.next_person_id, True, self.virus_name)
                    population.append(person)
                else:
    ...
    def _simulation_should_continue(self):
        ...
        if self.total_dead == self.population_size or infected == 0:
            return False
        else:
            return True
            ...
            for person in self.population:
                if person.infection != None and person.is_alive == True:
                    ...
                    while interactions < 99:
                        person2 = self.population[random.randint(0, len(self.population)) - 1]
                        if person2.is_alive == True and person2._id != person._id:
    ...
    def interaction(self, person, random_person):
        ...
        if random_person.is_vaccinated == True:
            #print("Person is vaccinated, Nothing happens.")
            self.logger.log_interaction(person, random_person, False, random_person.is_vaccinated)
        elif random_person.infection != None:
            #print("Person is already infected, Nothing happens.")
            self.logger.log_interaction(person, random_person, False, random_person.is_vaccinated, random_person.infection)
        else:
            repro_chance = random.uniform(0, 1)
            if repro_chance < self.basic_repro_num:
                #print("{} was infected by {}".format(random_person, person))
                self.newly_infected.append(random_person._id)
                self.logger.log_interaction(person, random_person, True, random_person.is_vaccinated, random_person.infection)
